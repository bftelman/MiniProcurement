...
public class DocumentProfile : Profile
{
    public DocumentProfile()
    {
        ...
        CreateMap<UpdateInvoiceDto, InvoiceRequest>()
            .ForPath(dest => dest.Document.CreatedOn, opt => opt.MapFrom(src => src.UpdatedOn));
        CreateMap<UpdatePurchaseRequestDto, PurchaseRequest>().ForPath(dest => dest.Document.CreatedOn,
