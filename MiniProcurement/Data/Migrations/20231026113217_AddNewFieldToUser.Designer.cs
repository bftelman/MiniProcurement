...
namespace MiniProcurement.Data.Migrations
{
    ...
    [Migration("20231026113217_AddNewFieldToUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MiniProcurement.Data.Entities.User", b =>
                {
                    ...
                    b.Property<int?>("ApprovingDocumentId")
                        .HasColumnType("int");
                    ...
                    b.Property<bool?>("HasApprovedDoc")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("ApprovingDocumentId");
            ...
            modelBuilder.Entity("MiniProcurement.Data.Entities.User", b =>
                {
                    b.HasOne("MiniProcurement.Data.Entities.Document", "ApprovingDocument")
                        .WithMany("ApproveList")
                        .HasForeignKey("ApprovingDocumentId");
                    ...
                    b.Navigation("ApprovingDocument");
