...
public class InvoiceController : ApplicationController
{
    ...
    {
        await _invoiceRequestService.CreateInvoiceRequest(User, createInvoiceDto);
        return Ok();
    }
    ...
    public async Task<IActionResult> UpdateInvoiceItem([FromRoute] int id, [FromRoute] int itemId,
        [FromBody] UpdateInvoiceItemDto updateInvoiceItemDto)
    {
