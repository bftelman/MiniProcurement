...
public class PurchaseRequestService : IPurchaseRequestService
{
    ...
    public async Task CreatePurchaseRequest(User user, CreatePurchaseRequestDto createPurchaseRequestDto)
    {
    ...
    {
        var prItem = await _context.PurchaseRequestItems.Where(prItem => prItem.PurchaseRequestId == id)
    ...
    public async Task UpdatePurchaseRequestItem(int id, int itemId,
        UpdatePurchaseRequestItemDto updatePurchaseDocumentItem)
    {
        var prItem = await _context.PurchaseRequestItems
                         .Where(prItem => prItem.PurchaseRequestId == id)
                         .FirstOrDefaultAsync(item => item.Id == itemId)
